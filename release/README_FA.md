...
*   **Nginx Reverse Proxy**: برای سرویس‌دهی امن به API و پنل مدیریت روی پورت استاندارد.
...
## ⚙️ تنظیمات
سرور به صورت پیش‌فرض روی پورت ۸۰ اجرا می‌شود.
*   **پنل مدیریت**: `http://<your-server-ip>/admin`
*   **آدرس متریکس**: `http://<your-server-ip>/_matrix`
