...
۲. **مشاهده لاگ**: مشاهده وضعیت لحظه‌ای سرور.
۳. **راه‌اندازی مجدد**: ریستارت سریع سرویس‌ها.
۴. **بررسی وضعیت**: مشاهده وضعیت سلامت کانتینرها.
۵. **تغییر وضعیت ثبت‌نام**: فعال/غیرفعال‌سازی هوشمند ثبت‌نام عمومی (نسخه ۳.۳).
۶. **تعمیر سریع (Quick Fix)**: تعمیر خودکار تنظیمات و دسترسی‌ها (حل مشکلات بوت).
